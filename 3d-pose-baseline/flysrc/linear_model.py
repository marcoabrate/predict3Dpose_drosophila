...
class LinearModel(object):
  ...
  def __init__(self,
    ...
    with vs.variable_scope( "linear_model" ):
      ...
      w1 = tf.compat.v1.get_variable( name="w1", initializer=kaiming, shape=[self.FLY_2D_SIZE, linear_size], dtype=dtype )
      ...
      w4 = tf.get_variable( name="w4", initializer=kaiming, shape=[linear_size, self.FLY_3D_SIZE], dtype=dtype )
